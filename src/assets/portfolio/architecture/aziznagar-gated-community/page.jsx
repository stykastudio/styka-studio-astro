...
import AZGC1 from "../../../../public/azgc/azgc1.webp";
import AZGC2 from "../../../../public/azgc/azgc2.webp";
import AZGC3 from "../../../../public/azgc/azgc3.webp";
import AZGC4 from "../../../../public/azgc/azgc4.webp";
		...
		<section className="bg-tan-900 dark:bg-jet pb-12">
			<div className="max-w-screen-xl mx-auto bg-tan-900 dark:bg-jet">
				<div className=" bg-tan-900 dark:bg-jet">
					...
					<div className="flex flex-col md:grid md:grid-cols-2 h-full gap-4 flex-wrap mx-2 md:mx-0 bg-white dark:bg-gray-800">
